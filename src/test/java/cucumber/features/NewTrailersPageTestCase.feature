...
Функция: Блок новые трейлеры
  ...
  Сценарий: Проигрывание трейлеров
    ...
    Дано устанавливает страницу "Блок Новые трейлеры", как активную
    И скролит к элементу "Новые трейлеры"
    То проверяет, что для всех элементов в "Название трейлера" при нажатии на элемент "Оранжевая кнопка проигрывания видео" отображается элемент "Плеер с трейлером" и закрывается при нажатии на элемент "Закрытие плеера с трейлером"
